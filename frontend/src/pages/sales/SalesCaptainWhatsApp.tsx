...
const SalesCaptainWhatsApp = () => {
  ...
  const handlePaste = async (event: ClipboardEvent<HTMLTextAreaElement | HTMLDivElement>) => {
    ...
    try {
      ...
      const response = await fetch('http://localhost:5000/api/ai/sales-captain/stream', {
        ...
        body: JSON.stringify({
          ...
          service: 'whatsapp', // Filter by WhatsApp service
  ...
  return (
    <Box
      sx={{
        ...
        background:
          'linear-gradient(180deg, rgba(37, 211, 102, 0.08) 0%, rgba(158, 229, 255, 0.05) 50%, rgba(255, 255, 255, 1) 100%)',
      }}
    >
      {/* Messages */}
      <Box
          ...
          >
            ...
            <Box>
              ...
              <Typography variant="body1" color="text.secondary" maxWidth={600}>
                I'm your Sales Captain for WhatsApp Marketing - here to help you during customer conversations. Ask me
                anything about:
              </Typography>
            </Box>
            <Stack direction="row" spacing={1} flexWrap="wrap" justifyContent="center">
              <Chip label="WhatsApp Marketing features" variant="outlined" />
              <Chip label="Campaign strategies" variant="outlined" />
              ...
              return (
                <Box key={message.id} sx={{ mb: 4 }}>
                  <AssistantMessage
                    ...
                    assistantName="Sales Captain - WhatsApp"
                    avatarNode={<WhatsAppIcon fontSize="small" />}
                    accentColor="#25D366"
                    secondaryAccentColor="#128C7E"
                  />
                </Box>
              );
            }
          ...
          <Stack direction="row" spacing={2} alignItems="flex-end">
            <IconButton
              ...
              sx={{
                ...
                borderRadius: 2,
                border: '1px dashed',
                borderColor: attachments.length >= 5 ? 'divider' : '#25D366',
                color: attachments.length >= 5 ? 'text.disabled' : '#128C7E',
              }}
            >
              <AttachFileIcon />
            </IconButton>
            <TextField
              ...
              multiline
              maxRows={4}
              placeholder="Ask me anything about WhatsApp Marketing... (e.g., 'What are the key benefits?')"
              value={input}
...
export default SalesCaptainWhatsApp;
